...
leftBtn.innerHTML  = `<svg viewBox="0 0 64 140">
  <path d="M32 5 L32 70" fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round"/>
</svg>`;

rightBtn.innerHTML = `<svg viewBox="0 0 64 140">
  <path d="M32 5 L32 70" fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round"/>
</svg>`;
