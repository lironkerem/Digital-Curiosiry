// js/engines/gratitude.js - WITH QUEST INTEGRATION
// ------------------------------------------------------------------
// Gratitude Journal – full gamification + edit/delete + neumorphic palette
// ------------------------------------------------------------------
...
export default class GratitudeEngine {
    ...
    tab.innerHTML = `
      <div class="min-h-screen p-6">
        <div class="max-w-7xl mx-auto">
          <h2 class="text-4xl font-bold mb-4" style="color: var(--neuro-text);">Gratitude Journal</h2>
          <p class="mb-8" style="color: var(--neuro-text-light); font-size: 1.1rem;">What are you grateful for today?</p>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
              ...
              <div class="card">
                <div class="flex items-center justify-between mb-6">
                  <h3 class="text-2xl font-bold" style="color: var(--neuro-text);">Today's Gratitudes</h3>
                ...
                <form onsubmit="window.featuresManager.engines.gratitude.addEntry(event)" class="mb-6">
                  <div class="flex space-x-3">
                    <input type="text" id="gratitude-input" class="form-input flex-1"
                           placeholder="I am grateful for..." required />
                ...
                <div class="space-y-3">
                  ...
                  ${this.currentEntries.length === 0 ? `
                    <div class="text-center py-12" style="color: var(--neuro-text-light);">
                      ...
                      <p>Start by adding your first gratitude</p>
                    </div>
                  ` : ''}
                </div>
              ...
              <!-- History card -->
              <div class="card">
                <h3 class="text-2xl font-bold mb-6" style="color: var(--neuro-text);">📖 My Gratitude Journal</h3>
                ${allEntries.length === 0 ? `
                  <div class="text-center py-12" style="color: var(--neuro-text-light);">
                    <p class="text-4xl mb-4">📖</p>
                    <p>Your gratitude journal will appear here</p>
                  </div>
                ` : `
                  <div class="space-y-6">
            ...
            <div class="space-y-6">
              <div class="card">
                <h3 class="text-lg font-bold mb-4" style="color: var(--neuro-text);">Need Inspiration?</h3>
                <div class="space-y-2">
                  ${[
                    ...
                    <div class="text-sm p-2 rounded cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700"
                         style="color: var(--neuro-text-light);"
  ...
  editEntry(index) {
    ...
    const updated = prompt('Edit gratitude:', original);
    if (updated && updated.trim()) {
      this.currentEntries[index] = updated.trim();
      this.render();
    }
  }
  ...
  deleteHistoryEntry(ts, idx) {
    if (!confirm('Delete this gratitude?')) return;
    const day = this.app.state.data.gratitudeEntries.find(e => e.timestamp === ts);
    if (!day) return;
  ...
  /* ----------  gamification save - WITH QUEST INTEGRATION  ---------- */
  save() {
    ...
    // ⭐ QUEST INTEGRATION: Trigger daily quest progress for each entry
  ...
  /* ----------  tiny helpers  ---------- */
  renderSavedFlips() { /* stub if you want live search */ }
  renderJournalEntries() { /* stub if you want live search */ }
}
